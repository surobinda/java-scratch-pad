package com.java.scratchpad.imagecompare;
...
class Example {
    public static void main( String[] args ) throws IOException {
        ...
        BufferedImage expectedImage = ImageComparisonUtil.readImageFromResources("actual.png");
        BufferedImage actualImage = ImageComparisonUtil.readImageFromResources("expected.png");

        // where to save the result (leave null if you want to see the result in the UI)
        File resultDestination = new File( "/Users/surobinda/development/core-java/java-scratch-pad/src/main/resources/result.png" );
        ...
        imageComparison.setMaximalRectangleCount(2);
